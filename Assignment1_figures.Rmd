...
ggplot(coral, aes(x=Taxa, y=AMR, fill = Taxa)) +
  ...
  theme_classic() +
  theme(legend.position = "none") +
  scale_fill_manual(values = c("orchid1", "gold", "steelblue1", "lightgreen")) +
  stat_summary(fun = "mean", geom = "point", shape = 21, size = 4, color = "black", fill = c("orchid4", "goldenrod4", "steelblue4", "palegreen4"))  +
  scale_x_discrete(labels = mylabels) +
  labs(x = "", y = "Arithmetic Mean Radius (cm)") +
  theme(axis.title = element_text(size = 12, family = "sans", face = "plain", color = "black"),
        axis.text.y = element_text(size = 12, family = "sans", color = "black"),
...
Size range for each coral taxa 
